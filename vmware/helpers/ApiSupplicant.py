...
class ApiSupplicant:
    ...
    def get(self) -> dict:
        ...
        try:
            # Fetch the remote resource from the VMware backend.
            ...
            if self.responseStatus == 200: # ok.
                ...
                raise CustomException(status=400, payload={"VMware": "Wrong credentials for the asset."})
            else:
                raise CustomException(status=self.responseStatus, payload={"VMware": self.responseObject})
