...
class VMwareHostSystemSerializer(serializers.Serializer):
    class VMwareHostSystemInnerSerializer(serializers.Serializer):
        ...
        moId = serializers.CharField(max_length=64, required=False)
        name = serializers.CharField(max_length=255, required=False, allow_blank=True)
        datastores = VMwareHostSystemDatastoresSerializer(many=True, required=False, allow_null=True)
        networks = VMwareHostSystemNetworksSerializer(many=True, required=False, allow_null=True)
