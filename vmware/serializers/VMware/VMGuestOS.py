...
class VMwareVMGuestOSSerializer(serializers.Serializer):
    ...
    class VMwareVMGuestOSToolsSerializer(serializers.Serializer):
        ...
        type = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=64)
    ...
    hostname = serializers.CharField(required=False, allow_blank=True,  allow_null=True, max_length=255)
